...
4. If the command prints nothing or errors, run `sh "${CLAUDE_PLUGIN_ROOT}/scripts/run.sh" doctor` and explain the problem in plain language (most often: Python 3.9+ is not installed).
